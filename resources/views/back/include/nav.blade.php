        ...
        <ul class="nav navbar-right top-nav pull-right">
            ...
            <li class="dropdown auth-drp">
                ...
                <ul class="dropdown-menu user-auth-dropdown" data-dropdown-in="flipInX" data-dropdown-out="flipOutX">
                    <li>
                        <a data-target="#userProfilModal" data-toggle="modal" href="javascript:void(0);"><i
                                class="zmdi zmdi-account"></i><span>Profil</span></a>
                    </li>
                    <li>
                        <a href="#"><i class="zmdi zmdi-settings"></i><span>Réglages</span></a>
                    </li>
                    <li class="divider"></li>
                    <li>
                        <a class="dropdown-item" href="{{ route('logout') }}" onclick="event.preventDefault();
                                                     document.getElementById('logout-form').submit();"><i
                                class="zmdi zmdi-power"></i><span>Deconnexion</span></a>
                    </li>
