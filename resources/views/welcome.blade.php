...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('soon/assets/bootstrap/css/bootstrap.min.css') }}" type="text/css">
    <link rel="stylesheet" href="{{ asset('soon/assets/font-awesome/css/fontawesome-all.min.css') }}">
    <link rel="stylesheet" href="{{ asset('soon/assets/css/magnific-popup.css') }}">
    <link rel="stylesheet" href="{{ asset('soon/assets/css/style.css') }}">
    <title>CryptoSoon - Coming Soon</title>
...
<body class="has-loading-screen ts-theme-dark">
            ...
            <header id="header">
                <nav class="navbar navbar-dark">
                    <a class="navbar-brand" href="#">
                        <img src="{{ asset('soon/assets/img/logo.png') }}" alt="">
                    </a>
            ...
            <main id="main-content">
                <div class="ts-content-wrapper">
                    <div class="row">
                        <!--Page Title-->
                        <div class="col-md-6">
                            <h1>Get Ready For The Futur Of<br> Money</h1>
                            <p>
                                The best way to trade cryptocurrency in 2021
                            </p>
                            <a href="#" class="btn btn-primary" onclick="alert('Be cool')">Learn
                                More</a>
                            <a href="https://www.youtube.com/watch?v=Qi3GOm1MhN0"
                                class="btn btn-outline-light video-popup"><i class="fa fa-play mr-2"></i>Video</a>
                        </div>
                        <!--end col-md-6-->
                        <!--Count Down-->
                        <div class="col-md-6">
                            <div class="text-center my-4">
                                <div class="ts-count-down" data-date="February 1, 2021 10:00:00"></div>
                                <!--end ts-count-down-->
                            </div>
                        </div>
                        <!--end col-md-6-->
    ...
    <div class="" data-bg-color="#001330">
        ...
        <div class="container-fluid">
                    ...
                    <div class="col-sm-6 col-xl-4">
                        <div class="d-flex align-items-center my-3">
                            <div class="ts-circle__md">
                                <figure class="ts-background-image" data-bg-image="assets/img/person-01.jpg"></figure>
                            </div>
                            <div class="ml-3">
            ...
            <section>
                ...
                <div class="row">
                    ...
                    <div class="col-xl-8">
                        <h3>Contact Form</h3>
                        <form id="form-contact" class="ts-form ts-form-email ts-inputs__transparent"
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <textarea class="form-control" id="form-contact-message" rows="6" name="message"
                            ...
                            <div class="form-group clearfix">
                                <button type="submit" class="btn float-right btn-outline-primary"
    ...
    <script src="{{ asset('soon/assets/js/jquery-3.3.1.min.js') }}"></script>
    <script src="{{ asset('soon/assets/js/popper.min.js') }}"></script>
    <script src="{{ asset('soon/assets/bootstrap/js/bootstrap.min.js') }}"></script>
    <script src="{{ asset('soon/assets/js/imagesloaded.pkgd.min.js') }}"></script>
    <script src="http://maps.google.com/maps/api/js?key=AIzaSyBEDfNcQRmKQEyulDN8nGWjLYPm8s4YB58"></script>
    <script src="{{ asset('soon/assets/js/waterpipe.js') }}"></script>
    <script src="{{ asset('soon/assets/js/jquery.magnific-popup.min.js') }}"></script>
    <script src="{{ asset('soon/assets/js/jquery.countdown.min.js') }}"></script>
    <script src="{{ asset('soon/assets/js/jquery.validate.min.js') }}"></script>
    <script src="{{ asset('soon/assets/js/jquery-validate.bootstrap-tooltip.min.js') }}"></script>
    ...
    <script>
        ...
        var markerImage = "soon/img/map-marker.png";
        var mapElement = "map";
